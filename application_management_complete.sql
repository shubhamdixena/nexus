...
SELECT 
    ...
    uap.user_id,
    uap.mba_school_id,
    COALESCE(ms.business_school, 'Unknown School') as school_name,
    COALESCE(ms.business_school, 'Unknown School') as business_school,
    COALESCE(ms.location, 'Unknown Location') as location,
    COALESCE(ms.country, 'Unknown Country') as country,
